  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Subscribe Online</Text>

        <Text style={styles.description}>
          To subscribe or reactivate your subscription, please visit our website.
          You'll get access to all the features you need to run your business.
        </Text>
        ...
        <View style={styles.benefitsList}>
          <View style={styles.benefitItem}>
            ...
            <Text style={styles.benefitText}>Flexible plans for any business size</Text>
          </View>
          <View style={styles.benefitItem}>
            <Ionicons name="checkmark-circle" size={20} color="#34C759" />
