...
const supabaseUrl = 'https://zionstxyesihmvaiffbw.supabase.co';
const supabaseServiceKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inppb25zdHh5ZXNpaG12YWlmZmJ3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNTczNTEyNSwiZXhwIjoyMDUxMzExMTI1fQ.G93lcElIo78bLK5BdPaGWuUqtWGx-csGeRTfiZe_rdU';
