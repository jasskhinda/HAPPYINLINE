  ...
  const handleInviteNewProvider = async () => {
    ...
    if (shopData) {
      ...
      if (currentProviderCount >= maxLicenses) {
        Alert.alert('Unable to Add Provider', 'You are unable to add more providers at this time. Please contact our support team for assistance.');
        return;
      }
    }
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.searchSection}>
                ...
                <Text style={styles.hint}>
                  Admins and receptionists can also be added to your team
                </Text>
              </View>
